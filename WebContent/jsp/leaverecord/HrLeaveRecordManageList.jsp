...
form="form1"
var="row"
items="pageBean.rsList" csvFileName="离职记录.csv"
retrieveRowsCallback="process" xlsFileName="离职记录.xls"
...
<ec:row styleClass="odd" oncontextmenu="selectRow(this,{LOCAT_ID:'${row.LOCAT_ID}'});refreshConextmenu()" onclick="selectRow(this,{LOCAT_ID:'${row.LOCAT_ID}'})">
	...
	<ec:column width="50" property="EMP_CODE" title="工号"   />
	<ec:column width="50" property="EMP_NAME" title="姓名"   />
	<ec:column width="50" property="EMP_JOB" title="职位"   />
	<ec:column width="70" property="IN_TIME" title="入职时间" cell="date" format="yyyy-MM-dd" />
	<ec:column width="70" property="OP_TIME" title="离职时间" cell="date" format="yyyy-MM-dd" />
	<ec:column width="50" property="LEAVE_RESON" title="离职原因" style="color:orange;"  />
